...
- Added **Getter and Setter** methods for data access
- Override the `toString()` method for readable console output

[feature/UC1-create-contact](https://github.com/abhishekkushwaha-2003/AddressBookApp/tree/feature/UC1-create-contact)
